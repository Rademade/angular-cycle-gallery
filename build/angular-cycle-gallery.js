...
(function() {
  angular.module('cycleGallery').service('animationService', function() {
    var DEFAULT_TIME, FRAME_ANIMATION_TIME, rafId, requestAnimationFrame;
    DEFAULT_TIME = 250;
    FRAME_ANIMATION_TIME = 1000 / 60;
    rafId = void 0;
    requestAnimationFrame = (function() {
      return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(callback) {
        return setTimeout(callback, FRAME_ANIMATION_TIME);
      };
    })();
    return {
      linear: function(animateParams) {
        var animate, start;
        cancelAnimationFrame(rafId);
        animateParams.time || (animateParams.time = DEFAULT_TIME);
        animateParams.element.style.transition = 'linear';
        start = +(new Date);
        animate = function() {
          var currentTime, newPosition, time;
          ...
          return animateParams.onUpdate();
        };
        return rafId = requestAnimationFrame(animate);
      },
      stop: function() {
...
(function() {
  angular.module('cycleGallery').service('GalleryMover', [
    'animationService', function(animationService) {
      var GalleryMover;
      return GalleryMover = (function() {
        ...
        GalleryMover.prototype._animate = function(position) {
          ...
          element = this._holder.getElement()[0];
          params = {
            element: element,
            left: position + 'px',
          ...
          return this._animation = animationService.linear(params);
        };
  ...
  angular.module('cycleGallery').service('MoverTouch', function() {
    ...
    return MoverTouch = (function() {
      ...
      MoverTouch.prototype._moveTrackingReload = function() {
        this._last_track_time = +new Date();
      ...
      MoverTouch.prototype._moveTracking = function(force) {
        ...
        track_timer_ready = +new Date() - this._last_track_time > this.TRACK_TIME;
